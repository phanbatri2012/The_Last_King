...
2. duplicate King HP, level, XP bar, and upgraded-skill details are absent from the screen HUD;
...
12. English and Vietnamese localization, automated tests, Windows export, Web export, and visual QA pass.
